...
public class Main {
    ...
    Counting words
        ...
        another thread, etc.
        i. Make sure you join all the starting threads so that the Main thread
        waits for all of them to complete and then accumulate their results,
        which are the number of words in each chunk of 300 lines.
        d. Print the time taken by both approaches and see the differences.
    */
